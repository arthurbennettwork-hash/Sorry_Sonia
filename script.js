/* =========================================================
   ...
   confetti, typing animation, sounds, music toggle.
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  musicToggle.addEventListener('click', () => {
    if (!isPlaying) {
      bgMusic.play().catch(() => {
        /* If no real music file has been added yet, playback will
           silently fail — that's expected until you replace the src */
      });
